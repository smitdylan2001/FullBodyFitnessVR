...
{
    public class PicoBodySampler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            for (int i = 0; i < BonesList.Count; i++)
            {
                if (BonesList[i] != null)
                {
                    ...
                    var BodyJoint = BonesList[i].GetComponent<BodyJoint>();
                    if (BodyJoint == null)
                    {
                        BodyJoint = BonesList[i].gameObject.AddComponent<BodyJoint>();
                        BodyJoint.bodyTrackerRole = (BodyTrackerRole)i;
                    }
        ...
        public void FindBonesReference()
        {
            ...
            BonesList[22] = GameObject
                    .Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/Spine1/Spine2/Chest/Shoulder_L/Arm_L/Arm_L_twist/ForeArm_L/ForeArm_L_twist01/ForeArm_L_twist02/Hand_L/MiddleFinger0_L/MiddleFinger1_L").transform;
            BonesList[23] = GameObject
                .Find(this.name + "/RIG/DeformationSystem/Root/GlobalScale/Hips/Spine1/Spine2/Chest/Shoulder_R/Arm_R/Arm_R_twist/ForeArm_R/ForeArm_R_twist01/ForeArm_R_twist02/Hand_R/MiddleFinger0_R/MiddleFinger1_R").transform;
        }
